...
class TestLocators:
    ...
    buns_block = By.XPATH, '/html/body/div/div/main/section[1]/div[1]/div[1]/span[text() = "Булки"]'

    # Заголовок раздела "Соусы" в меню конструктора
    sauces_block = By.XPATH, '/html/body/div/div/main/section[1]/div[1]/div[2]/span[text() = "Соусы"]'

    # Заголовок раздела "Начинки" в меню конструктора
    fillings_block = By.XPATH, '/html/body/div/div/main/section[1]/div[1]/div[3]/span[text() = "Начинки"]'
